<template>
  <div class="container">
      ...
      <div class="slide-content">
          ...
          <ul>
           <li><a href="#"><img src="../assets/img/t2.png" alt=""></a></li>
          </ul>
          <ul>
              <li><a href="#"><img src="../assets/img/t3.png" alt=""></a></li>
          </ul>
          <ul>
              <li><a href="#"><img src="../assets/img/t4.png" alt=""></a></li>
  
          </ul>
          <ul>
              <li><a href="#"><img src="../assets/img/t5.png" alt=""></a></li>
  
          </ul>
          <ul>
              <li><a href="#"><img src="../assets/img/t6.png" alt=""></a></li>
  
          </ul>
          <ul>
              <li><a href="#"><img src="../assets/img/t7.png" alt=""></a></li>
  
          </ul>
          <ul>
              <li><a href="#"><img src="../assets/img/t8.png" alt=""></a></li>
  
          </ul>
		  <ul>
		      <li><a href="#"><img src="../assets/img/t9.png" alt=""></a></li>
		    
		  </ul>
		  <ul>
		      <li><a href="#"><img src="../assets/img/t10.png" alt=""></a></li>
		    
		  </ul>
		  <ul>
		      <li><a href="#"><img src="../assets/img/t11.png" alt=""></a></li>
		    
		  </ul>
		  <ul>
		      <li><a href="#"><img src="../assets/img/t12.png" alt=""></a></li>
