    ...
    <el-carousel-item v-for="item in dataList" :key="item.index">
      <div class="it1">
        <div class="img">
          ...
          <!-- 播放按钮 -->
          <div class="play" ref="audio_ctr" @click="myplay(item.i)"></div>
          <div class="image">
            <img :src="item.img" />
          </div>
        </div>
      ...
      dataList: [
        {
          title: "机器人黑科技",
          i: 0,
          no: require("../assets/voice/冬奥黑科技/机器人.mp3"),
          img: require("../assets/img_page2/jq1.gif"),
        ...
        },
        {
          title: "转播黑科技",
          i: 1,
          no: require("../assets/voice/冬奥黑科技/转播.mp3"),
          img: require("../assets/img_page2/sxtt.gif"),
        ...
        },
        {
          title: "防疫黑科技",
          i: 2,
          no: require("../assets/voice/冬奥黑科技/防疫.mp3"),
          img: require("../assets/img_page2/ffy.jpg"),
        ...
        },
        {
          title: "交通黑科技",
          i: 3,
          no: require("../assets/voice/冬奥黑科技/交通.mp3"),
          img: require("../assets/img_page2/gt.jpg"),
          txt: "<p>&nbsp; &nbsp; 冬奥会专属列车：无人驾驶的智能高铁“复兴号”，时速高达每小时350公里，最远的赛场可以一小时内到达。全车每个车厢设置了5G华为设备，即便是列车在高速行驶状态中，或者是通过隧道、桥梁、屏蔽区时也可以保持信号稳定。</p>",
        },
        {
          title: "睡眠黑科技",
          i: 4,
          no: require("../assets/voice/冬奥黑科技/睡眠.mp3"),
          img: require("../assets/img_page2/bed.jpg"),
        ...
        },
        {
          title: "AI手语主播",
          i: 5,
          no: require("../assets/voice/冬奥黑科技/AI.mp3"),
          img: require("../assets/img_page2/aii.jpg"),
        ...
        },
        {
          title: "基建黑科技",
          i: 6,
          no: require("../assets/voice/冬奥黑科技/基建.mp3"),
          img: require("../assets/img_page2/jj.jpg"),
