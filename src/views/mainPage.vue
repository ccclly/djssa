		...
		<div class="left">
			<div class="left_one">
				...
				<el-tooltip
					...
					raw-content effect="light" placement="right">
		...
		<div class="min">
			...
			<div class="min_two">
				...
				<el-tooltip
					...
					raw-content effect="light" placement="left">
					<img src="../assets/i.png">
				</el-tooltip>
				<earth></earth>
			</div>
			<div class="min_three">
				...
				<el-tooltip
					...
					raw-content effect="light" placement="top-end">
					<img src="../assets/i.png">
				</el-tooltip>
				<cost></cost>
			</div>
		...
		<div class="right">
			...
			<div class="right_three">
				...
				<el-tooltip
					...
					raw-content effect="light" placement="top-start">
					<img src="../assets/i.png">
				</el-tooltip>
				<trend></trend>
			</div>
